...
def gep_multi(population, toolbox, n_generations=100, n_elites=1,
    ...
    .. note::
        ...
        random numerical constant manipulation. To adopt :func:`gep_multi` for GEP-RNC evolution, use the
